...
bool F_bubble = 0;
# F_stall = data || ret
bool F_stall = ((d_srcA != RNONE && d_srcA in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }) 
			   ||(d_srcB != RNONE && d_srcB in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }))
			   || (IRET in { D_icode, E_icode, M_icode });
...
# At most one of these can be true.
# D_stall = data && !jxx
bool D_stall = ((d_srcA != RNONE && d_srcA in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }) 
			   ||(d_srcB != RNONE && d_srcB in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }))
			   && !(E_icode == IJXX && !e_Cnd);
# D_bubble = (!data && ret) || jxx
bool D_bubble = (!((d_srcA != RNONE && d_srcA in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }) 
			   ||(d_srcB != RNONE && d_srcB in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }))
			   && (IRET in { D_icode, E_icode, M_icode }))
			   || (E_icode == IJXX && !e_Cnd);
...
bool E_stall = 0;
# E_bubble = data || jxx
bool E_bubble = ((d_srcA != RNONE && d_srcA in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }) 
			   ||(d_srcB != RNONE && d_srcB in { e_dstE, E_dstM, M_dstM, M_dstE, W_dstM, W_dstE }))
			   || (E_icode == IJXX && !e_Cnd);
